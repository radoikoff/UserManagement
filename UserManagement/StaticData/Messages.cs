...
namespace UserManagement
{
    public static class Messages
    {
        ...
        public const string UserIsMemeberOfEpSpecialGroup = "{0} is memeber of {1} and must be added to a manual group";
        ...
        public const string UserRemovedFromAllGRoupsExceptManualSpecialGroup = "{0} left only in {1}";
        ...
        public const string NewAutoUserGroupExists = "A new auto user groups has been used. ({0})";
